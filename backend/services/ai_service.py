...
class AIService:
    ...
    def _summary_system_prompt(level: str, language: str, custom_system_prompt: Optional[str] = None) -> str:
        ...
        system_prompt = custom_system_prompt or (
            ...
            '              {"label": "المفهوم الفرعي 2.3"}\n'
            '           ]\n'
            '        },\n'
            '        {\n'
            '           "label": "المحور 3",\n'
            '           "children": [\n'
            '              {"label": "المفهوم الفرعي 3.1"},\n'
            '              {"label": "المفهوم الفرعي 3.2"},\n'
            '              {"label": "المفهوم الفرعي 3.3"}\n'
            '           ]\n'
            '        }\n'
            '     ]\n'
            '  }\n'
            ...
            "\nقاعدة شمول الخريطة الذهنية (Mindmap Completeness):\n"
            "يجب أن تغطي الخريطة الذهنية جميع المحاور الرئيسية الواردة في المادة (5 إلى 8 محاور حسب المحتوى)، وتحت كل محور جميع المفاهيم الفرعية المرتبطة به (حتى 8 مفاهيم لكل محور)، دون اختصار أو دمج أو حذف لأي فرع. المثال أعلاه مختصر للتوضيح فقط وليس حداً أقصى لعدد الفروع."
        )
